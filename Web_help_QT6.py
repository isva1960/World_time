...
class HelpWindow(QtWidgets.QMainWindow, Ui_Help_Window):
    def __init__(self, org_name="isva_company", app_name="app_name", window_section="Help_Window",
                 window_title="", icon_name=None, url=None):
        super().__init__()
        self.setupUi(self)
        ...
        self.window_section = window_section  # Секция параметров окна
